...
- The coverage dashboard reads `fieldTypes`, `includeFields`, and `excludeFields` from `config.php` alone; blueprint narrowing does not change the rings. <https://kirby.tools/docs/content-translator/panel/translation-coverage.md>
