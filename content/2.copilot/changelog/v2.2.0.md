...
- **Anthropic image input**: Enable image input for prompts when using an **Anthropic** model.
...
- **API error handling**: Pass all API errors to the Panel user interface for better error handling. This helps to catch issues, such as the following with the `o3-mini` model:
