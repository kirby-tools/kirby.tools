...
description: "Point your coding agent at the documentation: every page as Markdown, llms.txt as the index, and a skill per plugin."
...
It writes them into whichever agent your project uses.
