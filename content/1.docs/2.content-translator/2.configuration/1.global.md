...
Recommended default – context-aware translation via your Kirby Copilot provider (OpenAI, Anthropic, Google, Mistral).
:::
...
### `strategy` :u-badge{label="Mixed" class="align-middle ml-2 rounded-full!" variant="subtle"} :u-badge{label="v3.11+" class="align-middle ml-2 rounded-full!" variant="subtle"}
...
### `batchConcurrency` :u-badge{label="Integer" class="align-middle ml-2 rounded-full!" variant="subtle"} :u-badge{label="v3.7.0+" class="align-middle ml-2 rounded-full!" variant="subtle"}
...
### `ai.systemPrompt` :u-badge{label="String" class="align-middle ml-2 rounded-full!" variant="subtle"} :u-badge{label="v3.10.0+" class="align-middle ml-2 rounded-full!" variant="subtle"}
