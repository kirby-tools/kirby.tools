...
### AI System Prompt :u-badge{label="v3.10.0+" class="align-middle ml-2 rounded-full!" variant="subtle"}
...
return [
    'johannschopplich.content-translator' => [
        'ai' => [
            'systemPrompt' => 'Your custom translation instructions…'
        ]
    ]
]
```
