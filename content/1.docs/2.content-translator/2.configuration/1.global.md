...
At least one translation provider must be configured for the plugin to work: DeepL, a custom translation function, or [Kirby Copilot](/docs/content-translator/configuration/ai-translation).
...
### AI Translation (Kirby Copilot) :u-badge{label="v3.9.0+" class="align-middle ml-2 rounded-full!" variant="subtle"}

When [Kirby Copilot](/copilot) is installed and configured, Content Translator automatically detects it and offers AI translation as an additional provider. No extra configuration is required in Content Translator.

::callout{icon="i-ri-sparkling-line" color="info" to="/docs/content-translator/configuration/ai-translation"}
Learn more about AI translation setup and provider comparison in the **AI Translation** guide.
::
