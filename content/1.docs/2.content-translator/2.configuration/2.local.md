...
For the full per-tag attribute reference and translation behaviour, see the [KirbyTags Configuration](/docs/content-translator/advanced/kirbytags) guide.

### `systemPrompt` :u-badge{label="String" class="align-middle ml-2 rounded-full!" variant="subtle"} :u-badge{label="v3.10.0+" class="align-middle ml-2 rounded-full!" variant="subtle"}
