...
_Import_ copies the raw content, then _Translate_ sends it through the configured provider – so you can review the copy first, or skip translating content that doesn't need it.
::
