---
title: Migration
description: Upgrade from v1 to v3 with before/after config examples covering field type handling, HTML tag fixes, and Kirby 5 view buttons.
---
...
**Configuration**<br>
A comprehensive guide to all the available configuration properties for the Content Translator section.
::
