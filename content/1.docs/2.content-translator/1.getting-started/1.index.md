...
Kirby Content Translator is a plugin for [Kirby CMS](https://getkirby.com) that adds a translation button to any page, file, or site blueprint. Translate via [DeepL](https://www.deepl.com), through [Kirby Copilot](/copilot) for AI-powered translation, or your own backend – the same pipeline is available from PHP and the CLI for hooks, custom controllers, and batch jobs.
