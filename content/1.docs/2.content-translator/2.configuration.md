...
With the disabled `import` feature (and `bulk` feature for the sake if the screenshot), the section will look like this:
...
::preview{src="/img/kirby-content-translator-section-import-all-disabled.png"}
::
...
::preview{src="/img/kirby-content-translator-section-help.png"}
::
