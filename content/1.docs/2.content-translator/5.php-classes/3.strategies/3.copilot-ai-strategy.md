...
::callout{icon="i-ri-arrow-right-line" color="info" to="/docs/content-translator/advanced/hooks#rejection-reasons"}
For the reasons it reports, and to wire it to logging or alerting, see **Rejection Reasons** under Hooks.
::
