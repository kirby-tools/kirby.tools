...
::warning
`'strategy' => 'ai'` throws `LogicException` when [Kirby Copilot](/docs/copilot) is not installed. An unknown string throws `LogicException('Unknown strategy "<name>"')`.
::
