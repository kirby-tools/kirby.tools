...
2. **Emit `content-translator.translate:warning`** for each unit you return as `null` – nothing else does, because your reason is the specific one and the recorded rejection only says `missing translation`.
