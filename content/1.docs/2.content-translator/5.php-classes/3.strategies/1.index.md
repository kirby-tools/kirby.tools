...
- **KirbyTag placeholders are validated afterwards.** Any unit that lost or invented a `<cN/>` token is reverted to source and reported through the warning hook, whichever strategy produced it.
