...
:::card{title="Value Objects" icon="i-ri-box-3-line" to="/docs/content-translator/php-classes/value-objects"}
`TranslationUnit`, `ExecutionOptions`, `TranslationLanguage`, `TranslationMode` – the typed payloads passed through the pipeline.
:::
