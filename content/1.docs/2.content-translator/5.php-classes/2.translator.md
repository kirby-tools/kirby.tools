...
// $result->translatableCount – units handed to the strategy
// $result->translatedCount – units that came back usable
...
A `placeholder mismatch` rejection also carries the `expected` and `actual` placeholder index lists.
