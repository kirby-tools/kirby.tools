...
The provider selection dialog will show "ChatGPT" instead of "OpenAI":

::preview{src="/img/kirby-content-translator-provider-toggle.png" alt="Content Translator batch translation dialog" width="1296" height="210"}
::
