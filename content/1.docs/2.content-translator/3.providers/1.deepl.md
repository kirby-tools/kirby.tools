...
When neither your Kirby language code nor its locale names a language DeepL supports, translation fails with a `LogicException`. Map the code to a DeepL target code instead:
