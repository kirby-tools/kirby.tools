...
### v2.2.1 :u-badge{label="Latest" class="align-middle ml-2 !rounded-full" variant="subtle"}

Released on October 2, 2024.

**🚀 Features**

- Log DeepL API erros, such as when the API quota is exceeded or the character limit has been reached.
