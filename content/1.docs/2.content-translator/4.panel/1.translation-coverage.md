...
Open `/panel/languages` (or the Languages icon in the Panel topbar) to see the coverage dashboard. Each language shows a completion ring and a list of incomplete pages – click a page to open it, or one of its language tags to open it in the language that's missing content.
