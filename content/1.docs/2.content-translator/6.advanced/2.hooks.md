...
The full [TranslationUnit](/docs/content-translator/php-classes/value-objects#translationunit) (`text`, `mode`, `fieldKey`). Lets you branch on the originating field or table cell.
::

::field{name="options" type="ExecutionOptions"}
Typed [ExecutionOptions](/docs/content-translator/php-classes/value-objects#executionoptions) carrying both `targetLanguage` and `sourceLanguage` as `TranslationLanguage` value objects.
::
