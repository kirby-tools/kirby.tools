...
The button carries no detail. Open the browser console for the actual error – usually the render request failing, because the template raised an error on the unsaved content it was handed.
