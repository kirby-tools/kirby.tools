...
Clicking a link inside the preview opens the matching Panel view instead of following the link. Two kinds of links are left alone: anchors with a fragment, which scroll inside the preview as usual, and anchors marked with `data-preview-ignore`.
