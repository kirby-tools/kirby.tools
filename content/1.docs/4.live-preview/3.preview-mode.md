...
- **Anchors with a fragment** stay in the preview, including relative ones like `/about#team` – the preview navigates to that page rather than opening its Panel view.
