...
Pick the site or page blueprint you want the Live Preview section in. Add the following section configuration to the blueprint file:
...
Fit the Live Preview section to your blueprint layout and customize it as needed. It can be part of any column, and it can be sticky, which helps when you edit blocks or other fields beside it:
...
The page renders right there and updates as you type:
...
Press :kbd{value="meta"} :kbd{value="S"} (macOS) / :kbd{value="CTRL"} :kbd{value="S"} (Windows/Linux) inside the preview to save the current page without leaving it.
...
::callout{icon="i-ri-information-line" color="info" to="/docs/live-preview/troubleshooting"}
