...
Kirby Live Preview adds a Panel section that renders any page in an iframe and updates as editors type. Navigate by clicking links inside the preview – the matching Panel view opens instead of the linked page. Pin the section sticky to keep it visible while editing blocks and other fields side-by-side.
