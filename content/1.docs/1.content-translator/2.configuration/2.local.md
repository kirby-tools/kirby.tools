...
The Content Translator view button can be added to any Panel view (site, page, file) alongside the default buttons like the preview button or languages dropdown. Configure its behavior with props in your blueprints:
