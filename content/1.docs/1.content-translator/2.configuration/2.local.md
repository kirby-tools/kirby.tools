...
Kirby Content Translator can be added to Panel views via a **view button** (recommended) or a **section**. Both approaches support the same configuration options and can be used together.
