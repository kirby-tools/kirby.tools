...
### v3.2.6 :u-badge{label="Latest" class="align-middle ml-2 !rounded-full" variant="subtle"}

Released on April 8, 2025.

**🐞 Bug Fixes**

- Invalidate view button to avoid memory leaks when navigating between pages in the Panel.
