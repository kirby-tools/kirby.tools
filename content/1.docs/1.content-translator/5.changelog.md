...
### v3.1.0 :u-badge{label="Latest" class="align-middle ml-2 !rounded-full" variant="subtle"}

Released on January 20, 2025.

**🚀 Features**

- Select the languages to translate the content into when using the [bulk translation](/docs/content-translator/configuration#bulk) feature:
