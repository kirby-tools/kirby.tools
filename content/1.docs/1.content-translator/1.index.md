...
Kirby 4 does not support custom view buttons, but the `content-translator` button has been backported 🎉. It is always placed in front of the language dropdown and cannot be moved. Follow the [configuration guide](/docs/content-translator/configuration#panel-view-button) for more information or how to disable it.
::
...
::callout{icon="i-ri-information-line" to="/docs/live-preview/configuration"}
