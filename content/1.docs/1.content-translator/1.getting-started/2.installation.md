...
To add the `content-translator` button to a Panel view, set the `buttons` option in the corresponding blueprint. Reference the default buttons and decide where to place the `content-translator` button:
