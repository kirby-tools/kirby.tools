...
::preview{src="/img/kirby-content-translator-section-import-all.png" alt="Content Translator section with import all option"}
::
...
::preview{src="/img/kirby-content-translator-section-batch-disabled.png" alt="Content Translator section with batch translation disabled"}
::
