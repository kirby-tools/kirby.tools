...
report:
    ...
    - rating: bad
      text: >-
          <a href="https://yoa.st/33o">Keyphrase in slug</a>: <a href="https://yoa.st/33p">Please add both a keyphrase and a slug containing the keyphrase</a>.
---
::::
:::::
:::::panel-box{theme="empty" icon="clock" text="9/4/25, 8:40 AM" class="border-transparent"}
:::::
::::::
:::::::
::::::::
