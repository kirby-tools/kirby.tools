...
Click the **Analyze** button to run a SEO and readability analysis on the current page. Results are grouped into Good, OK, Needs improvement, Feedback, and Errors – empty groups are omitted:
