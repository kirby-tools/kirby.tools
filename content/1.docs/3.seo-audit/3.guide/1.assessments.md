...
- **SEO assessments**: Powered by the Yoast SEO engine, focusing on keyword optimization, meta data, links, and technical SEO factors
...
Results are grouped into Good, OK, Needs improvement, Feedback, and Errors, regardless of whether an assessment is SEO or readability – see [Introduction](/docs/seo-audit/getting-started) for what each category means.
