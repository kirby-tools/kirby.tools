...
When the preview URL origin differs from the Panel origin, the Panel posts the URL to the plugin's proxy route and Kirby fetches the page server-side – that avoids CORS errors. Same-origin URLs are fetched directly in the browser.
