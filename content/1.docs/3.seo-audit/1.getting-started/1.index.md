...
Kirby SEO Audit brings the Yoast SEO v3 analysis engine – the one millions of WordPress users rely on – into the Kirby Panel. Everything runs in the editor's browser; no external services, no API calls, no data leaving your server.
