...
Kirby SEO Audit is a plugin for [Kirby CMS](https://getkirby.com) that brings the Yoast SEO v3 analysis engine – the one millions of WordPress users rely on – directly into the Panel. Everything runs in the editor's browser; no external services, no API calls, no data leaving your server.
