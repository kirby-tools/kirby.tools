...
SEO assessments that analyze how the keyphrase is used, such as Introduction Keyword, Meta Description Keyword, or Function Words, need a defined keyphrase – see [`keyphraseField`](/docs/seo-audit/configuration/local#keyphrasefield) for what happens without one. You can define blueprint fields for the keyword and its synonyms to be analyzed with your page. These fields can be used by both the view button and section:
