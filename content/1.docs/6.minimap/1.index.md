...
Kirby Minimap is a plugin for [Kirby CMS](https://getkirby.com). Install it, and a structured sidebar appears next to the site view and every page view – no license activation, no setup.
...
1. **Collapsed State**  
   Displays a minimal vertical indicator with a marker for each field and an icon for each block, maintaining an unobtrusive presence.
