...
Controls AI auto-completion in writer fields. Inline suggestions are enabled by default for all writer fields.

**Default:** `['debounce' => 1000]`

To disable auto-completion globally:
...
::callout{icon="i-ri-ai-generate" color="info" to="/docs/copilot/usage/auto-completion"}
Learn more about auto-completion behavior and keyboard shortcuts.
::
