...
description: Configure Copilot view buttons, sections, and writer/textarea fields in your blueprints with fine-grained control over AI generation behavior.
---

Kirby Copilot supports configuration through view buttons (in Kirby 5+), sections, and individual writer/textarea fields, providing fine-grained control over AI generation behavior. All approaches support similar configuration options and can be used together.
...
::callout{icon="i-ri-information-line" color="info" to="/docs/copilot/usage/toolbar-buttons#custom-user-prompts"}
Learn more about custom prompts for Writer and Textarea fields in the **Toolbar Buttons** documentation.
::

## Available Options

::tip
When [configured globally](/docs/copilot/configuration/global), these options will apply to view buttons, sections, and triter/textarea fields. Local configurations can override them.
::
