...
Kirby Copilot supports configuration through view buttons (in Kirby 5+) and sections, providing fine-grained control over AI generation behavior. Both approaches support the same configuration options and can be used together.
