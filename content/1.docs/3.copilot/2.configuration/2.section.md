...
Kirby Copilot comes in many flavors. If you want to get the most out of the plugin, you should check the Panel view button. It allows you to open the prompt dialog from anywhere in the Panel and generate content for multiple fields at once. The Copilot section is limited to one field at the time.
