...
The toolbar buttons allow you to work with the selected text or the entire field content. If any text is selected, an [additional selection menu](/docs/copilot/usage/toolbar-buttons#selected-text) will appear to choose whether to replace the selected text with the generated content or to append the generated content to the selected text.
