...
When replacing selected text in writer fields, Copilot preserves your existing formatting. Bold, italic, links, and all other marks are maintained in the generated content.

This is especially useful with [prompt templates](/docs/copilot/prompt-dialog/templates) like **Fix Grammar** or **Make Concise**: correct errors or shorten text while keeping all your formatting intact.
...
When you select text in a writer or textarea field before clicking the Copilot button, the selection is appended to your prompt. In writer fields, formatting (bold, italic, links, etc.) is preserved in the selection.
