...
On a Kirby file page, you can pre-select the **current file** as context for the user prompt. This is useful if you want to generate text for a specific file, such as an image or PDF file, that has already been uploaded to the Panel.
...
sections:
  ...
  copilot:
    ...
    field: alt
    # Provide a predefined user prompt
