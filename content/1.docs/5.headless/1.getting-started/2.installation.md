...
Download the :latest-version or head over to the [releases page](https://github.com/johannschopplich/kirby-headless/releases) to see all versions. Extract the ZIP file to your `site/plugins` folder.
