...
Open a page that uses the blueprint. With nothing else configured, the title line reads the page title as last saved, an en dash, and the site title. Underneath comes the site URL followed by the page path, and there is no description:
