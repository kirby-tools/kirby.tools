...
Pick a page blueprint and add the section:
...
Open a page that uses the blueprint. With nothing else configured, the snippet shows the page title, an en dash and the site title on the title line, the site URL followed by the page path underneath, and no description:
