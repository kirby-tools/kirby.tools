...
Open a page that uses the blueprint. With nothing else configured, the snippet opens with the site title and the site URL followed by the page path. Below them, the title line reads the page title as last saved, an en dash, and the site title. There is no description:
