...
By default, SEO reports are saved to the browser's local storage. This allows editors to close the Panel and return later without rerunning the analysis. It's also useful for comparing "before" and "after" results when optimizing content.
