...
| Paragraph Length        | `textParagraphTooLong` | Paragraphs don't exceed 150 words                    |
| Sentence Length         | `textSentenceLength`   | Sentences don't exceed 20 words on average           |
...
| Sentence Beginnings     | `sentenceBeginnings`   | Sentences don't start the same way repeatedly        |
| Word Complexity         | `wordComplexity`       | Vocabulary isn't overly complex                      |
