...
:download-latest or head over to the [releases page](https://github.com/kirby-tools/kirby-seo-audit/releases) to see all versions. Extract the ZIP file to your `site/plugins` folder. It should look like this:
