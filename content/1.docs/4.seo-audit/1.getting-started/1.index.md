...
- **View Button**: :u-badge{label="Recommended" color="primary" size="sm" class="align-text-bottom"}
  Add a single line to your blueprint and get an SEO Audit button in your page header. Click it, and the analysis results appear in a dialog. Available in Kirby 5+.
- **Section**:
  Add a section to your blueprints for inline audit results. Click the "Analyze" button in the section to run the analysis. Works with Kirby 4 and 5.

Both methods use the same analysis engine and support the same configuration options.
