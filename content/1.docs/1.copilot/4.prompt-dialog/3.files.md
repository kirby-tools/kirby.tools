...
The PDF file is sent directly to the AI provider along with your prompt, allowing the AI model to understand the document's structure, formatting, and content natively.
