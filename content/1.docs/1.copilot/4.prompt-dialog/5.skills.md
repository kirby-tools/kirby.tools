...
::callout{icon="i-ri-bookmark-line" color="info" to="/docs/copilot/prompt-dialog/templates"}
Skills compose with any prompt. For complete, reusable prompts you invoke as a single unit, see **Prompt Templates**.
::

::callout{icon="i-ri-settings-3-line" color="neutral" to="/docs/copilot/configuration/system-prompt"}
