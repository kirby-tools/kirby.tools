...
description: Pull a sibling page's title and content into the prompt with an @page:// reference – the AI sees structured cross-page context.
---
...
::tip
A page reference must not start inside a word – `see@page://about` stays plain text. Punctuation around it is fine, so `"@page://about"` resolves.
::
...
::note
Page references remain visible in the prompt text. The AI receives both the references and the resolved page content.
::
