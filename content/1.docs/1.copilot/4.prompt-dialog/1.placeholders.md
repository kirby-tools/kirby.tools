...
prompt: |-
  ...
  {content}
preview: |-
  Summarize this article "Kirby CMS: Adapting to You" in a meta description (max 155 characters). Include the main benefit and end with a subtle call-to-action. No quotes.

  This is the article:
  [ { "content": { "level": "h1", "text": "Kirby CMS: The Perfect Balance for Developers and Designers" }, "type": "heading" }, { "content": { "text": "Kirby CMS has carved out a unique space in the crowded world of content management systems. …" }, "type": "text" } ]
---
::
:::
