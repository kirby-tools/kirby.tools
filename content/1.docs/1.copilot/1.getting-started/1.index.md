...
:::card{title="OpenAI" icon="i-simple-icons-openai" to="https://developers.openai.com/api/docs/models"}
...
:::card{title="Mistral" icon="i-simple-icons-mistralai" to="https://docs.mistral.ai/models/overview"}
...
:prose-video{src="/screencasts/kirby-copilot-multi-fields-generation.mp4" poster="/screencasts/kirby-copilot-multi-fields-generation-poster.jpg" width="908" height="540"}
...
:prose-video{src="/screencasts/kirby-copilot-generate-layouts.mp4" poster="/screencasts/kirby-copilot-generate-layouts-poster.jpg" width="908" height="540"}
...
Experience Kirby Copilot firsthand in the [interactive playground](https://try.kirbycopilot.com). Bring your own provider API key – the playground runs entirely in your browser, so you can see exactly where your key goes. Production installs route through a server-side proxy and never expose keys to Panel users.
