---
title: Installation
description: Set up your AI provider, choose from four workflows, and activate your license.
---
...
::warning
Create a separate API key for each project, so you can revoke one without touching the others.
::
...
If you are unsure where to start, add the `copilot` **view button** to your blueprint first.
...
:::card{title="Inline Suggestions" icon="i-ri-magic-line" to="/docs/copilot/usage/inline-suggestions"}
