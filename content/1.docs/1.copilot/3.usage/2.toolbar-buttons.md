...
If you select text before opening the dialog, the selection is automatically sent ahead of your prompt. See the [selected text](#selected-text) section for details.
...
[Placeholders](/docs/copilot/prompt-dialog/placeholders), [page references](/docs/copilot/prompt-dialog/page-references), and [skill references](/docs/copilot/prompt-dialog/skills) resolve only in your prompt, never in the selection.
