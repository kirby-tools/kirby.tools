...
previewOpen: true
fields: 3
prompt: Create a product page for "{title}". Use the product image attached.
preview: Create a product page for "ZEHA Leather Shoe Liga". Use the product image attached.
dropdown:
  under: fields
  value:
    - description
...
dropdown:
  under: history
  items:
    - text: 'Draft three headline options for this article.'
    - text: 'Summarize this article "{title}" in a meta description (max 155 characters). Include the main benefit and end with a subtle call-to-action.'
    - text: 'Rewrite the introduction in a more casual voice.'
    - text: 'Create a product page for "{title}". Use the product image attached.'
---
::
:::
