...
- **Attached files** like images and PDFs
...
| `writer` toolbar mark      | `rich-text`     | Double newlines between paragraphs, inline HTML tags                                       |
...
The [inline suggestions feature](/docs/copilot/usage/inline-suggestions) uses a separate system prompt that keeps each suggestion short. It cannot be customized.
