---
title: System Prompt
description: Ships with an auto-adapting default prompt that adjusts to the target field type, selection context, and file attachments – customizable globally or per blueprint.
---
...
The [inline suggestions feature](/docs/copilot/usage/inline-suggestions) uses a separate, lightweight system prompt optimized for inline text suggestions. This prompt cannot be customized:
