...
::note
For generating [Blocks and Layouts](/docs/copilot/advanced/blocks-and-layouts) or other structured data, I recommend Google Gemini models. Create a new [Google API key](https://aistudio.google.com/api-keys) and add it to the configuration along with the AI model such as Gemini 3.1 Pro.
::
