...
::tip
When [configured globally](/docs/copilot/configuration/global), these properties will apply to view buttons and writer/textarea fields. Local configurations can override them.
::
