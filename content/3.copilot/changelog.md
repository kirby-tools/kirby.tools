...
If you have downloaded the plugin as a ZIP file, :download-latest or head over to the [releases page](https://github.com/kirby-tools/kirby-copilot/releases) to see all versions.
