...
- New [View Button](/docs/seo-audit/getting-started/installation#view-button) for Kirby 5, allowing you to run SEO analysis from any page without adding a section to your blueprint.
- Upgrade from Yoast SEO v1 to Yoast SEO v3 with overhauled assessments and improved performance.
- New assessment: `imageKeyphrase` – Analyzes if images are optimized for your target keyphrase.
