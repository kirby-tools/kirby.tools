...
- **Runs report what they translated**: A run that leaves segments in the source language now says how many. A run whose provider fails outright is reported as an error instead. See [Translation Results](/docs/content-translator/panel/translation-results).
