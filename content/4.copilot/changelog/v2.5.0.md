...
- New [Panel view button](/docs/copilot/usage/view-button) to open the prompt dialog anywhere. You can select multiple fields and generate their content with a single prompt.
